...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    role: "FX Artist",
    cardHighlight: "Cloth & Hair Simulation · Cinematic FX",
    year: "2024",
    duration: "2024",
    ...
    contributions: [
      "I spent most of my time on this trailer working on the characters' cloth and hair simulation.",
      "There was some FX work too: foam, water splashes, lightning, fire, and explosions. A bit of everything.",
      "I've picked a few screenshots from the work below. The bugs made it into the breakdown too 😅",
    ],
    techStack: ["Unreal Engine", "Houdini", "Blender"],
    engine: "Unreal Engine",
    technicalHighlights: [
      "Character cloth simulation and collision setup in Unreal Engine",
      "Hair simulation with Niagara groom controls",
    ],
    technicalNotes: [
      "For the cloth, I kept coming back to one question: how does the garment move around the character? I worked on the setup and checked it against the collision shapes in Unreal.",
      "Hair was a lot of small adjustments in Niagara: curl noise strength, frequency, direction, then another look at how the strands moved. It's easier to judge in motion than in a still frame.",
    ],
    videoUrl: "https://www.youtube.com/embed/qK8jtTMHCRU",
    evidenceBreakdown: [
      {
        image: "/assets/projects/new-world/cloth-and-collision.webp",
        title: "Getting the cloth moving",
        caption: "A garment preview on the left, and a collision check on the right. Those purple shapes show the body the cloth has to move around. I handled the simulation setup here; the character models and costumes came from the team.",
        tag: "Cloth · Work in progress",
      },
      {
        image: "/assets/projects/new-world/hair-simulation-controls.webp",
        title: "Tuning the hair motion",
        caption: "This is the Niagara groom setup I worked with. The exposed controls let me adjust the curl-noise strength, frequency, and direction without digging through the setup each time. Handy little controls 🙂",
        tag: "Hair · Niagara",
      },
      {
        image: "/assets/projects/new-world/simulation-outtakes.webp",
        title: "Well... that happened 😅",
        caption: "Left: the coat ate its owner. Right: I was working on a character and somehow got a kite instead 😂 Two bugs from production that deserved a spot here.",
        tag: "Outtakes · Unreal / Houdini",
      },
    ],
